...
import pb.auth.Authentication;
import pb.auth.HttpBasicAuth;
import pb.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.pitneybowes.com/location-intelligence";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/8.5.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pitneybowes.com/location-intelligence
...
* Helper method to set access token for the first OAuth2 authentication.
*
* @param apiKey apiKey recieved from Pitney Bowes Developer portal.
* @param secret secret recieved from Pitney Bowes Developer portal.
*/
