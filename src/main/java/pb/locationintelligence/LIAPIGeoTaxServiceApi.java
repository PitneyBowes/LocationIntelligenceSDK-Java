...
public class LIAPIGeoTaxServiceApi {
    ...
    private com.squareup.okhttp.Call getIPDTaxByAddressCall(String address, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TaxDistrictResponse getIPDTaxByAddress(String address) throws ApiException {
        ApiResponse<TaxDistrictResponse> resp = getIPDTaxByAddressWithHttpInfo(address);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TaxDistrictResponse> getIPDTaxByAddressWithHttpInfo(String address) throws ApiException {
        com.squareup.okhttp.Call call = getIPDTaxByAddressCall(address, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getIPDTaxByAddressAsync(String address, final ApiCallback<TaxDistrictResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getIPDTaxByAddressCall(address, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TaxDistrictResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
