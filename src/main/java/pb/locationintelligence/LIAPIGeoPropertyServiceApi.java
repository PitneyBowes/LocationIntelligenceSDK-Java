...
public class LIAPIGeoPropertyServiceApi {
    ...
    /* Build call for getParcelBoundaryByPBKey */
    private com.squareup.okhttp.Call getParcelBoundaryByPBKeyCall(String pbKey, String accept, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'pbKey' is set
        if (pbKey == null) {
            throw new ApiException("Missing the required parameter 'pbKey' when calling getParcelBoundaryByPBKey(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/geoproperty/v1/parcelboundary/bypbkey".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ParcelBoundary getParcelBoundaryByPBKey(String pbKey, String accept) throws ApiException {
        ApiResponse<ParcelBoundary> resp = getParcelBoundaryByPBKeyWithHttpInfo(pbKey, accept);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ParcelBoundary> getParcelBoundaryByPBKeyWithHttpInfo(String pbKey, String accept) throws ApiException {
        com.squareup.okhttp.Call call = getParcelBoundaryByPBKeyCall(pbKey, accept, null, null);
        Type localVarReturnType = new TypeToken<ParcelBoundary>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getParcelBoundaryByPBKeyAsync(String pbKey, String accept, final ApiCallback<ParcelBoundary> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getParcelBoundaryByPBKeyCall(pbKey, accept, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ParcelBoundary>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
