...
public class LIAPIGeocodeServiceApi {
    ...
    private com.squareup.okhttp.Call getPBKeyCall(String address, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public PBKeyResponse getPBKey(String address, String country) throws ApiException {
        ApiResponse<PBKeyResponse> resp = getPBKeyWithHttpInfo(address, country);
        return resp.getData();
    }
    ...
    public ApiResponse<PBKeyResponse> getPBKeyWithHttpInfo(String address, String country) throws ApiException {
        com.squareup.okhttp.Call call = getPBKeyCall(address, country, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPBKeyAsync(String address, String country, final ApiCallback<PBKeyResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPBKeyCall(address, country, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PBKeyResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getPBKeysCall(PBKeyAddressRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling getPBKeys(Async)");
        }
    ...
    private com.squareup.okhttp.Call keyLookupCall(String key, String type, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/geocode-service/v1/keylookup".replaceAll("\\{format\\}","json");
    ...
    /**
     * Get List of Address (asynchronously)
     * Gets Address for an input free form PBKey text
     * @param body  (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
