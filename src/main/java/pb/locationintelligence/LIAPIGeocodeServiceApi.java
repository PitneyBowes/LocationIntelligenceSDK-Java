...
public class LIAPIGeocodeServiceApi {
    ...
    /* Build call for geocodeServiceV1TransientDatapackBundleReverseGeocodePost */
    private com.squareup.okhttp.Call geocodeServiceV1TransientDatapackBundleReverseGeocodePostCall(String datapackBundle, ReverseGeocodeRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // verify the required parameter 'datapackBundle' is set
        if (datapackBundle == null) {
            throw new ApiException("Missing the required parameter 'datapackBundle' when calling geocodeServiceV1TransientDatapackBundleReverseGeocodePost(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GeocodeServiceResponseList geocodeServiceV1TransientDatapackBundleReverseGeocodePost(String datapackBundle, ReverseGeocodeRequest body) throws ApiException {
        ApiResponse<GeocodeServiceResponseList> resp = geocodeServiceV1TransientDatapackBundleReverseGeocodePostWithHttpInfo(datapackBundle, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GeocodeServiceResponseList> geocodeServiceV1TransientDatapackBundleReverseGeocodePostWithHttpInfo(String datapackBundle, ReverseGeocodeRequest body) throws ApiException {
        com.squareup.okhttp.Call call = geocodeServiceV1TransientDatapackBundleReverseGeocodePostCall(datapackBundle, body, null, null);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponseList>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call geocodeServiceV1TransientDatapackBundleReverseGeocodePostAsync(String datapackBundle, ReverseGeocodeRequest body, final ApiCallback<GeocodeServiceResponseList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = geocodeServiceV1TransientDatapackBundleReverseGeocodePostCall(datapackBundle, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponseList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
