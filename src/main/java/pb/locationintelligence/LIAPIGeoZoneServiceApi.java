...
public class LIAPIGeoZoneServiceApi {
    ...
    /* Build call for getPOIBoundaryByPBKey */
    private com.squareup.okhttp.Call getPOIBoundaryByPBKeyCall(String pbKey, String categoryCode, String sicCode, String naicsCode, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'pbKey' is set
        if (pbKey == null) {
            throw new ApiException("Missing the required parameter 'pbKey' when calling getPOIBoundaryByPBKey(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/geozone/v1/poiboundary/bypbkey".replaceAll("\\{format\\}","json");
     ...
     * Gets Point of Interests Boundary by PBKey
     * @param pbKey PBKey for which POI Boundary is requested (required)
     * @param categoryCode Specific Category/Categories Codes for the desired POIs. Accepts a mix of 4 digit (Top Category), 6 digit (Second-Level Category) and 11 digit (Low-Level Category) Category Codes. (optional)
     * @param sicCode Specify starting digits or full sic code to filter the response (optional)
     * @param naicsCode Will accept naicsCode to filter POIs in results. Max 10 allowed. (optional)
     * @return PoiBoundary
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PoiBoundary getPOIBoundaryByPBKey(String pbKey, String categoryCode, String sicCode, String naicsCode) throws ApiException {
        ApiResponse<PoiBoundary> resp = getPOIBoundaryByPBKeyWithHttpInfo(pbKey, categoryCode, sicCode, naicsCode);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PoiBoundary> getPOIBoundaryByPBKeyWithHttpInfo(String pbKey, String categoryCode, String sicCode, String naicsCode) throws ApiException {
        com.squareup.okhttp.Call call = getPOIBoundaryByPBKeyCall(pbKey, categoryCode, sicCode, naicsCode, null, null);
        Type localVarReturnType = new TypeToken<PoiBoundary>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets Point of Interests Boundary by PBKey (asynchronously)
     * Gets Point of Interests Boundary by PBKey
     * @param pbKey PBKey for which POI Boundary is requested (required)
     * @param categoryCode Specific Category/Categories Codes for the desired POIs. Accepts a mix of 4 digit (Top Category), 6 digit (Second-Level Category) and 11 digit (Low-Level Category) Category Codes. (optional)
     * @param sicCode Specify starting digits or full sic code to filter the response (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPOIBoundaryByPBKeyAsync(String pbKey, String categoryCode, String sicCode, String naicsCode, final ApiCallback<PoiBoundary> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPOIBoundaryByPBKeyCall(pbKey, categoryCode, sicCode, naicsCode, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PoiBoundary>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getPOIBoundaryByPBKeyBatch */
    private com.squareup.okhttp.Call getPOIBoundaryByPBKeyBatchCall(POIBoundaryPBKeyRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public POIBoundaryResponse getPOIBoundaryByPBKeyBatch(POIBoundaryPBKeyRequest body) throws ApiException {
        ApiResponse<POIBoundaryResponse> resp = getPOIBoundaryByPBKeyBatchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<POIBoundaryResponse> getPOIBoundaryByPBKeyBatchWithHttpInfo(POIBoundaryPBKeyRequest body) throws ApiException {
        com.squareup.okhttp.Call call = getPOIBoundaryByPBKeyBatchCall(body, null, null);
        Type localVarReturnType = new TypeToken<POIBoundaryResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Batch method for getting Point of Interests Boundary by PBKey (asynchronously)
     * Batch method for getting Point of Interests Boundary by PBKey
     * @param body  (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPOIBoundaryByPBKeyBatchAsync(POIBoundaryPBKeyRequest body, final ApiCallback<POIBoundaryResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPOIBoundaryByPBKeyBatchCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<POIBoundaryResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
