...
public class LIAPIGeoIdentityServiceApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GeoIdentityResponse getIdentityByPBKey(String pbKey, String givenName, String familyName, String confidence, String maxCandidates, String theme, String filter) throws ApiException {
        ApiResponse<GeoIdentityResponse> resp = getIdentityByPBKeyWithHttpInfo(pbKey, givenName, familyName, confidence, maxCandidates, theme, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GeoIdentityResponse> getIdentityByPBKeyWithHttpInfo(String pbKey, String givenName, String familyName, String confidence, String maxCandidates, String theme, String filter) throws ApiException {
        com.squareup.okhttp.Call call = getIdentityByPBKeyCall(pbKey, givenName, familyName, confidence, maxCandidates, theme, filter, null, null);
        Type localVarReturnType = new TypeToken<GeoIdentityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getIdentityByPBKeyAsync(String pbKey, String givenName, String familyName, String confidence, String maxCandidates, String theme, String filter, final ApiCallback<GeoIdentityResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getIdentityByPBKeyCall(pbKey, givenName, familyName, confidence, maxCandidates, theme, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeoIdentityResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
