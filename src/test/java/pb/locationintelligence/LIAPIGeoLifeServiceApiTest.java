...
public class LIAPIGeoLifeServiceApiTest {
    ...
    public void getDemographicsByAddressTest() throws ApiException {
        ...
        String filter = null;
        String country = null;
        // Demographics response = api.getDemographicsByAddress(address, profile, filter, country);
    ...
    public void getDemographicsByLocationTest() throws ApiException {
        ...
        String profile = null;
        String filter = null;
        // Demographics response = api.getDemographicsByLocation(longitude, latitude, profile, filter);
