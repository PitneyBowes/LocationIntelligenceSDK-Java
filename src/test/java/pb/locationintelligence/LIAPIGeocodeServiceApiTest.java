...
public class LIAPIGeocodeServiceApiTest {
    ...
    public void geocodeBatchTest() throws ApiException {
        ...
        // GeocodeServiceResponseList response = api.geocodeBatch(datapackBundle, body);
     ...
     */
    @Test
    public void geocodeServiceV1TransientDatapackBundleReverseGeocodePostTest() throws ApiException {
        String datapackBundle = null;
        ReverseGeocodeRequest body = null;
        // GeocodeServiceResponseList response = api.geocodeServiceV1TransientDatapackBundleReverseGeocodePost(datapackBundle, body);
