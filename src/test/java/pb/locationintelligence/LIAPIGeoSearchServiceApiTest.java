...
public class LIAPIGeoSearchServiceApiTest {
    ...
    public void geoSearchTest() throws ApiException {
        ...
        // Locations response = api.geoSearch(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode);
