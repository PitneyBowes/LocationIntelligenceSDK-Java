...
```groovy
compile "io.swagger:LocationIntelligenceJavaSDK:7.0.0"
```
...
* target/LocationIntelligenceJavaSDK-7.0.0.jar
* target/lib/*.jar
...
*LIAPIGeocodeServiceApi* | [**geocodeISRIBatch**](docs/LIAPIGeocodeServiceApi.md#geocodeISRIBatch) | **POST** /geocode-service/v1/arcgis/rest/services/PBLocator/GeocodeServer/geocodeAddresses | Get Address
...
*LIAPIGeocodeServiceApi* | [**getESRICapabilities**](docs/LIAPIGeocodeServiceApi.md#getESRICapabilities) | **GET** /geocode-service/v1/arcgis/rest/services/PBLocator/GeocodeServer | Gets Capabilities
